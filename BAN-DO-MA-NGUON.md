...
| **Mẫu PO-03 — Phiếu xuất kho** (26/09/2026) sai bố cục / thiếu ô | Tờ in: `1-giao-dien/thanh-phan-nghiep-vu/to-phieu-xuat-kho-a4.tsx` (được `to-don-mua-hang-a4.tsx` rẽ nhánh gọi) · Xem nhanh trên form: `khoi-tong-quan-phieu-xuat-kho.tsx` · Ô nhập: `form-lap-don-mua-hang.tsx` (khối "Thông tin phiếu xuất kho") · Luật + mã **[CHỜ CHỐT]**: `2-quy-trinh/phieu-xuat-kho.ts` · Trường dữ liệu: `DonDatHang.*XuatKho` / `khoXuat` / `diaDiemKhoXuat` trong `3-du-lieu/kieu-du-lieu.ts`. ⚠️ Chế độ SỬA đơn còn khoá nhóm ô này — `ThayDoiDonHang` chưa nhận |
