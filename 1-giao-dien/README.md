...
| `to-phieu-xuat-kho-a4.tsx` | **Bản vẽ tờ PHIẾU XUẤT KHO A4 — Mẫu PO-03** (Sếp 26/09/2026), bám biểu mẫu `1. INPUT/Phieu xuat kho   HPCons.xlsx`. 🔴 **Không gọi thẳng từ trang in** — `to-don-mua-hang-a4.tsx` tự rẽ sang đây khi `po.mauPO === "phieu_xuat_kho"`, nên cả hai trang in đều đúng mẫu. Màu viết cứng như mọi tờ in. Cột "Thực xuất" luôn trống (thủ kho ghi tay) |
| `khoi-tong-quan-phieu-xuat-kho.tsx` | **Khối "Xem nhanh phiếu xuất kho"** trên màn lập đơn khi chọn Mẫu PO-03 — bày đúng thứ tự ô của biểu mẫu từ chính đơn tạm mà nút In dùng. **Chỉ đọc**, dùng token V1.1 (khác tờ in); điện thoại chuyển bảng thành thẻ |
