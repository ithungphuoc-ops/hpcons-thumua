        ...
        <div className="flex min-w-0 flex-col gap-(--hp-md-section)">
          ...
          {duocXemBaoGiaCuaDeNghi(dn, nguoiDung.uid, quyen) && (
            <KhoiDaNccTheoDong
              ...
              quyen={quyen}
              hoSoDaDong={hoSoDaDong}
              onLuuDeXuat={(sttDongDeNghi, deXuat) =>
                luuDeXuatChoDongBaoGia(dn.id, sttDongDeNghi, deXuat, nguoiDung.tenHienThi)
              }
              onDuyet={(bgId, sttDongDeNghi, quyetDinh) =>
                duyetDongBaoGia(bgId, sttDongDeNghi, quyetDinh, nguoiDung.tenHienThi)
              }
