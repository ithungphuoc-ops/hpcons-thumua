        ...
        <div data-rong-toan-man className="flex min-h-[420px] flex-1 flex-col gap-2">
          ...
          <Dialog open={xemPopupId !== null} onOpenChange={(mo) => !mo && setXemPopupId(null)}>
            ...
            {/**
              ...
              *    được, phải F5.
              *
              * 🔬 CƠ CHẾ (đo thật trên production, xem bảng dưới):
              *    ① Nút "Chọn tệp" thật ra là `<label>` bọc một `<input type="file" class="sr-only">`
              *       — ô này chỉ 1px, nằm sâu dưới đáy nội dung.
              *    ② Bấm vào là ô ẩn đó NHẬN FOCUS, và trình duyệt tự cuộn nó vào tầm nhìn.
              *    ③ Trình duyệt cuộn MỌI tổ tiên cuộn được. `overflow: hidden` **vẫn là một
              *       vùng cuộn hợp lệ** — nó chỉ giấu thanh cuộn và chặn chuột, KHÔNG chặn
              *       trình duyệt cuộn bằng lệnh. Nên chính khối này bị cuộn đi 1227px.
              ...
              *    trình duyệt không có gì để cuộn, nên thanh xanh không thể trôi đi đâu. Đã
              *    thử A/B trên chính production: có `clip` thì khối cuộn 0px, thanh xanh đứng
              *    nguyên y=65.
              *
