...
export interface DonDatHang {
   ...
   * "failed". Người mở màn chi tiết thấy khối đỏ "Đồng bộ QLK CTR thất bại" thì tưởng app hỏng
   * và đi báo lỗi, trong khi app đang chạy ĐÚNG luật. Một dấu sai đọc được là một lần người ta
   * mất công đi tìm thứ không tồn tại.
   *
